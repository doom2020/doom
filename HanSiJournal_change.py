...
class HanSiJournal:
    ...
    class AdvancesInPsychology:
        ...
        def __init__(self):
            ...
            self.classify = "Advances in Psychology"
        ...
        def get_img(self, src_image):
            ...
            self.img2save(page_html)

        def img2save(self, page_html):
            md5 = hashlib.md5()
            ...
            try:
                ...
                try:
                    if result[index_e + 1] == "q" or result[index_e + 2] == "q":
                        good_email = result[:index_e + 1] + self.email_type
                        print("处理后的邮箱:", good_email)
                        return good_email
                    else:
                        good_email = result
                        print("未经处理的邮箱:", good_email)
                        return good_email
                except IndexError:
                    print("图片异常")
                    return False
